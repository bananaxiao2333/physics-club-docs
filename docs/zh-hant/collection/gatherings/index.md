...
tags:
  ...
  - 2026-04-27
  - 2026-05-12
# ⚠️ 由 tools/docsgen.py 從 content/collection/gatherings/index.zh-hans.md 生成，請勿手改；要改請改 content/ 下的源文件。 （本頁由 zh-hans 版腳本轉換而來，不是另譯）
---
...
=== "04.27 · 計劃的下一頁"
    ...
    **完整 PDF · 14 頁** —— [打開原稿](../../../assets/originals/assembly-427.pdf){ target=_blank }
    ...
    → 制度正文見 [會費與貢獻積分](../../system/governance/fees.md)
...
=== "05.12 · 向未來的設想"
    ...
    **完整 PDF · 5 頁** —— [打開原稿](../../../assets/originals/assembly-512.pdf){ target=_blank }
    ...
    → 分組名單見 [組織架構與名單](../../system/governance/roster.md)
    → 功勳系統見 [功勳系統](../../system/merit/index.md)
