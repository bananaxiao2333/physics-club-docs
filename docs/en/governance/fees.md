---
title: Membership Dues and the Contribution Credit System
...
# ⚠️ 由 tools/docsgen.py 从 content/governance/fees.en.md 生成，请勿手改；要改请改 content/ 下的源文件。
---
...
- **Voluntary participation** —— paying dues is not a precondition for joining the club; not paying does not affect participation in everyday activities
- **Compliant operation** —— club dues and credits stay within their bounds and are not designed as a currency
...
| --- | --- |
| The reimbursement lag | Official school approval and reimbursement take a process, while equipment and materials often have to be bought in advance, so the club must be able to cover costs in the short term |
...
**Fixed fund pool** —— used to advance club spending that can be reimbursed, covering the lag before school approval.
Emphasis on keeping vouchers and settling them afterwards; **it is not a source of personal gain**.

**Activity fund pool** —— used to cover some activity costs that cannot be reimbursed,
such as small materials, event organisation and welfare arrangements; spending must be directly related to club activities,
and the amount, purpose and approval process are public.
...
They should be: a record of contribution within the club · a tool to encourage participation · a record of entitlement to welfare activities · an auxiliary mechanism for club self-governance.

They should not be: a currency, token or coin · an investment or financing instrument · a promise of fixed return or dividends · a certificate that can be transferred, traded or cashed out.

Credits are earned around real contribution: **participation** (attending regular meetings, taking part in experiments, joining club activities),
**contribution** (explaining problems, helping to organise, completing club tasks),
**performance** (winning competitions, outstanding contribution to a major event),
ultimately forming a record of contribution under public rules.
...
1. **Submit a request** —— a member submits a written request and explains the reason
2. **Review the record** —— review according to the rules, keeping the time, amount and basis on file
3. **Return a result** —— inform the member of the outcome and, where necessary, publish the basis in the rules
4. **Explain and appeal** —— members may raise objections, add explanations, or apply for a review
...
- **Overall income and expenditure**: publish sources of income, publish uses of expenditure, summarise and disclose regularly
...
3. Establish the ledger —— record income and expenditure, vouchers, personal records and the disclosure cycle in one place
4. Review regularly —— check how it is working every month or every term and revise what is wrong
...
their skills and preferred roles (editing, photography, both, or none for now),
whether they were willing to take part in content production for payment,
and their reasons for wanting to join the physics club.
The results of the questionnaire are used only for the club's internal statistics and planning.
