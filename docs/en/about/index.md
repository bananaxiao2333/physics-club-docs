...
The surviving material is not complete: some dates go no further than a month, some
events are mentioned only in passing, and some rules never left the draft stage.
Faced with those gaps, this site chooses:
...
-   __Sources__
    ...
    The list of originals, and which facts each one establishes.

    [:octicons-arrow-right-24: View the sources](sources/index.md)

-   __Thanks & Afterword__

    ---

    To everyone who was here.

    [:octicons-arrow-right-24: Read the afterword](thanks/index.md)
