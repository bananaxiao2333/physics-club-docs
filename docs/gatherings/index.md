...
nav: ["0421", "0427", "0512"]
# ⚠️ 由 tools/docsgen.py 从 content/gatherings/index.zh.md 生成，请勿手改；要改请改 content/ 下的源文件。
---
...
=== "04.27 · 计划的下一页"
    ...
    **完整 PDF · 14 页** —— [打开原稿](../assets/originals/assembly-427.pdf){ target=_blank }
    ...
    → 制度正文见 [会费与贡献积分](../governance/fees.md)
...
=== "05.12 · 向未来的设想"
    ...
    **完整 PDF · 5 页** —— [打开原稿](../assets/originals/assembly-512.pdf){ target=_blank }
    ...
    → 分组名单见 [组织架构与名单](../governance/roster.md)
    → 功勋系统见 [功勋系统](../merit/index.md)
